// Transcrypt'ed from Python, 2019-05-01 02:21:30
...
export var view_sol_number = function (state, actions) {
	...
	return h ('div', dict ({}), [h ('label', dict ({'for': state ['sol_number_ref']}), 'SolNumber: '), h ('input', dict ({'id': state ['sol_number_ref'], 'step': '0.00001', 'type': 'number', 'value': state ['sol_number'].sol_number}), ''), h ('button', dict ({'onclick': (function __lambda__ (event) {
		if (arguments.length) {
			var __ilastarg0__ = arguments.length - 1;
			if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
				var __allkwargs0__ = arguments [__ilastarg0__--];
...
export var view_imperial_date_time = function (state, actions) {
	...
	var ref = state ['imperial_date_time_ref'];
	return h ('div', dict ({}), [h ('label', dict ({'for': ref + 'year'}), 'ImperialDateTime: '), h ('input', dict ({'id': ref + 'year', 'type': 'number', 'value': imperial_date_time.year}), ''), '-', h ('input', dict ({'id': ref + 'month', 'type': 'number', 'value': imperial_date_time.month}), ''), '-', h ('input', dict ({'id': ref + 'day', 'type': 'number', 'value': imperial_date_time.day}), ''), 'T', h ('input', dict ({'id': ref + 'hour', 'type': 'number', 'value': imperial_date_time.hour}), ''), ':', h ('input', dict ({'id': ref + 'minute', 'type': 'number', 'value': imperial_date_time.minute}), ''), ':', h ('input', dict ({'id': ref + 'second', 'type': 'number', 'value': imperial_date_time.second}), ''), h ('button', dict ({'onclick': (function __lambda__ (event) {
		if (arguments.length) {
			var __ilastarg0__ = arguments.length - 1;
			if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
				var __allkwargs0__ = arguments [__ilastarg0__--];
