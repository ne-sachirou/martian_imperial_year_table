...
import {sol_number_to_imperial_date_time} from './imperial_calendar.js';
var __name__ = '__main__';
export var action_sol_number_to_imperial_date_time = function (state, event) {
	if (arguments.length) {
...
export var view = function (state, actions) {
	...
	return h ('div', dict ({}), [h ('form', dict ({}), [h ('div', dict ({}), [h ('label', dict ({'for': state ['sol_number_ref']}), 'SolNumber: '), h ('input', dict ({'id': state ['sol_number_ref'], 'step': '0.00001', 'type': 'number', 'value': state ['sol_number'].sol_number}), '')]), h ('button', dict ({'onclick': (function __lambda__ (event) {
		...
		return actions ['sol_number_to_imperial_date_time'] (event);
	})}), 'to ImperialDateTime')]), h ('div', dict ({}), 'ImperialDateTime: {}-{}-{}T{}:{}:{}'.format (imperial_date_time.year, imperial_date_time.month, imperial_date_time.day, imperial_date_time.hour, imperial_date_time.minute, imperial_date_time.second))]);
};
export var main = function () {
	...
	var actions = dict ({'sol_number_to_imperial_date_time': (function __lambda__ (event) {
		if (arguments.length) {
			var __ilastarg0__ = arguments.length - 1;
			if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
				var __allkwargs0__ = arguments [__ilastarg0__--];
		...
		return (function __lambda__ (state) {
			...
			return action_sol_number_to_imperial_date_time (state, event);
		});
	})});
