// Transcrypt'ed from Python, 2019-06-02 22:59:39
...
export var action_sync_by_imsn = function (state, event) {
	...
	var juld = tert_to_juld (tert);
	var grdt = juld_to_grdt (juld);
	var imdt = imsn_to_imdt (state.imperial_imsn);
	return dict ({'grdt': grdt, 'juld': juld, 'tert': tert, 'mrsd': mrsd, 'imsn': imsn, 'imdt': imdt});
};
...
export var view_grdt = function (state, actions) {
	...
	return h ('div', dict ({'class': 'field is-grouped is-grouped-multiline'}), [h ('label', dict ({'class': 'label', 'for': ref + 'year'}), 'Gregorian Date Time'), h ('input', dict ({'id': ref + 'year', 'class': 'input', 'style': dict ({'width': '6em'}), 'type': 'number', 'value': grdt.year}), ''), '-', h ('input', dict ({'id': ref + 'month', 'class': 'input', 'max': 12, 'min': 1, 'style': dict ({'width': '3em'}), 'type': 'number', 'value': grdt.month}), ''), '-', h ('input', dict ({'id': ref + 'day', 'class': 'input', 'max': 31, 'min': 1, 'style': dict ({'width': '3em'}), 'type': 'number', 'value': grdt.day}), ''), 'T', h ('input', dict ({'id': ref + 'hour', 'class': 'input', 'style': dict ({'width': '3em'}), 'type': 'number', 'value': grdt.hour}), ''), ':', h ('input', dict ({'id': ref + 'minute', 'class': 'input', 'style': dict ({'width': '3em'}), 'type': 'number', 'value': grdt.minute}), ''), ':', h ('input', dict ({'id': ref + 'second', 'class': 'input', 'style': dict ({'width': '3em'}), 'type': 'number', 'value': grdt.second}), ''), h ('input', dict ({'class': 'input', 'style': dict ({'width': '6em'}), 'type': 'text', 'value': grdt.timezone_str}), ''), h ('button', dict ({'class': 'button is-dark', 'onclick': (function __lambda__ (event) {
		if (arguments.length) {
			var __ilastarg0__ = arguments.length - 1;
			if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
				var __allkwargs0__ = arguments [__ilastarg0__--];
...
export var view_imdt = function (state, actions) {
	...
	var imdt = state ['imdt'];
	var ref = state ['imdt_ref'];
	return h ('div', dict ({'class': 'field is-grouped is-grouped-multiline'}), [h ('label', dict ({'class': 'label', 'for': ref + 'year'}), 'Imperial Date Time'), h ('input', dict ({'id': ref + 'year', 'class': 'input', 'style': dict ({'width': '6em'}), 'type': 'number', 'value': imdt.year}), ''), '-', h ('input', dict ({'id': ref + 'month', 'class': 'input', 'max': 24, 'min': 1, 'style': dict ({'width': '3em'}), 'type': 'number', 'value': imdt.month}), ''), '-', h ('input', dict ({'id': ref + 'day', 'class': 'input', 'max': 28, 'min': 1, 'style': dict ({'width': '3em'}), 'type': 'number', 'value': imdt.day}), ''), 'T', h ('input', dict ({'id': ref + 'hour', 'class': 'input', 'style': dict ({'width': '3em'}), 'type': 'number', 'value': imdt.hour}), ''), ':', h ('input', dict ({'id': ref + 'minute', 'class': 'input', 'style': dict ({'width': '3em'}), 'type': 'number', 'value': imdt.minute}), ''), ':', h ('input', dict ({'id': ref + 'second', 'class': 'input', 'style': dict ({'width': '3em'}), 'type': 'number', 'value': imdt.second}), ''), h ('input', dict ({'class': 'input', 'style': dict ({'width': '6em'}), 'type': 'text', 'value': '+00:00'}), ''), h ('button', dict ({'class': 'button is-dark', 'onclick': (function __lambda__ (event) {
		if (arguments.length) {
			var __ilastarg0__ = arguments.length - 1;
			if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
				var __allkwargs0__ = arguments [__ilastarg0__--];
