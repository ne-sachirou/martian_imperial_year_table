// Transcrypt'ed from Python, 2019-06-29 12:32:34
...
var __name__ = 'imperial_calendar.GregorianDateTime';
export var GregorianDateTime =  __class__ ('GregorianDateTime', [object], {
	__module__: __name__,
	intercept: 1721088.5,
	...
	get __eq__ () {return __get__ (this, function (self, other) {
		...
		if (!(isinstance (other, GregorianDateTime))) {
			return false;
		}
...
Object.defineProperty (GregorianDateTime, 'timezone_str', property.call (GregorianDateTime, GregorianDateTime._get_timezone_str));;

//# sourceMappingURL=imperial_calendar.GregorianDateTime.map