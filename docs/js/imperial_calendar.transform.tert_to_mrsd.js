...
var __name__ = 'imperial_calendar.transform.tert_to_mrsd';
export var tert_to_mrsd = function (tert) {
	if (arguments.length) {
...
//# sourceMappingURL=imperial_calendar.transform.tert_to_mrsd.map