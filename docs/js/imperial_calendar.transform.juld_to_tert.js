...
var __name__ = 'imperial_calendar.transform.juld_to_tert';
export var juld_to_tert = function (juld) {
	if (arguments.length) {
...
//# sourceMappingURL=imperial_calendar.transform.juld_to_tert.map