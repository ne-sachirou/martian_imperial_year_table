...
def action_sync_by_grdt(state, event):
    ...
    grdt = GregorianDateTime(int(document.getElementById(ref + "year").value),
                             ...
                             GregorianDateTime.parse_timezone_str(document.getElementById(ref + "timezone").value))
...
def action_sync_by_imdt(state, event):
    ...
    event.preventDefault()
    ref = state["imdt_ref"]
    imdt = ImperialDateTime(int(document.getElementById(ref + "year").value),
                            int(document.getElementById(ref + "month").value),
                            int(document.getElementById(ref + "day").value),
                            int(document.getElementById(ref + "hour").value),
                            int(document.getElementById(ref + "minute").value),
                            int(document.getElementById(ref + "second").value),
                            ImperialDateTime.parse_timezone_str(document.getElementById(ref + "timezone").value))
...
def view_delta_t(state, actions):
    """View ⊿t."""
    juld = state["juld"]
    return h("div", {"class": "field is-grouped"}, [h("div", {"class": "label"}, "⊿t"), str(juld.delta_t)])
...
def view(state, actions):
    """View."""
    return h("div", {},
             [view_grdt, view_juld, view_delta_t, view_tert, view_mrls, view_mrsd, view_imperial_imsn, view_imdt])
