...
export var view = function (state, actions) {
	...
	})}), 'to MartianDateTime')]), h ('div', dict ({}), 'MartianDateTime: {}-{}-{}T{}:{}:{}'.format (martian_date_time.year, martian_date_time.month, martian_date_time.day, martian_date_time.hour, martian_date_time.hour, martian_date_time.second))]);
};
