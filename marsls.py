...
def mars_mean_anomaly(offset_t_j2000):
    """Mを求める。"""
...
def equation_of_center(offset_t_j2000):
    """ν-Mを求める。"""

    m_m_a = mars_mean_anomaly(offset_t_j2000)
    angle_m = math.radians(m_m_a)
    pbs = perturbers(offset_t_j2000)
...
def areocentric_solar_longitude(offset_t_j2000):
    """Ls=火星中心太陽黃經を求める。"""

    areocentric_solar_longitude = (angle_of_fictitious_mean_sun(offset_t_j2000) \
        + equation_of_center(offset_t_j2000)) % 360
